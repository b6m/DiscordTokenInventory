...
# ^ pro code moment instead of using os.system('title title_goes_here')
threads                                 = []
    ...
    with open('tokens.txt') as e:
        for line in e:
            ...
            try:
                ...
                _inventory =  httpx.get(_api,headers                     =      _headers)
                if 'code' in _inventory.text:
                    ...
                    for code in codes:
                        ...
                        with open('codes.txt', 'a') as f : f.write(f"{_code} - {_title}\n")
            except: pass
